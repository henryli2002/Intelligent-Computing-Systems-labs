...
if __name__ == '__main__':
    ...
    param = torch.load("./models/fst.pth")
    g_net.load_state_dict(param)
    ...
    for i, image in enumerate(data_group):
        ...
        images = torch.cat([image_g_mlu, image_c], dim=0)
        save_image(images, f"./out/mlu_cnnl_mfus/image{i}.jpg")
